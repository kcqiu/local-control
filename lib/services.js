...
const recgovPath = process.env.LOCAL_CONTROL_RECGOV_PATH || path.join(userHome, "Documents", "ChatGPT", "recgov");
const register2ParkPath = process.env.LOCAL_CONTROL_REGISTER2PARK_PATH || path.join(userHome, "Documents", "auto register r2park");
...
const SERVICES = {
  recgov: {
    ...
    portScript: path.join(recgovPath, "scripts", "start-recgov.ps1"),
    path: recgovPath,
    launcher: process.env.LOCAL_CONTROL_RECGOV_LAUNCHER || path.join(userHome, "Desktop", "RecGov Booker.cmd"),
    envKey: "NTFY_TOPIC",
    envFile: path.join(recgovPath, ".env"),
  },
  register2park: {
    id: "register2park",
    name: "Register2Park",
    ...
    path: register2ParkPath,
    launcher: process.env.LOCAL_CONTROL_REGISTER2PARK_LAUNCHER || path.join(userHome, "Desktop", "Register2Park Helper.lnk"),
    envKey: "R2P_NOTIFICATION_TOPIC",
    envFile: path.join(register2ParkPath, ".env"),
  },
};
